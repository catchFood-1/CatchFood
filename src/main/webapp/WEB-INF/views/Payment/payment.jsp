...
<body>
	...
	결제 방법을 선택하세요.<p>
	<button onclick="requestPay('kakaopay.TC0ONETIME')">카카오페이 결제</button>
	<button onclick="requestPay('tosspay.tosstest')">토스페이</button>
	<button onclick="requestPay('payco.PARTNERTEST')">페이코</button>
